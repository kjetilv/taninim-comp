...
var G__21750 = o;
reagent.impl.template.goog$module$goog$object.set(G__21750,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__21763 = o;
reagent.impl.template.goog$module$goog$object.set(G__21763,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__22070__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__22071__i < G__22071__a.length) {G__22071__a[G__22071__i] = arguments[G__22071__i + 0]; ++G__22071__i;}
  args = new cljs.core.IndexedSeq(G__22071__a,0,null);
} 
...
var args = cljs.core.seq(arglist__22072);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21783__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5162__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__21803 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21803,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__21803;
}
})(),id_class);
...
var temp__5825__auto___22073 = (function (){var and__5160__auto__ = js_props;
...
if(cljs.core.truth_(temp__5825__auto___22073)){
var d_22074 = temp__5825__auto___22073;
if((d_22074 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_22074.s}));
} else {
...
var G__21821 = (cljs.core.count(argv) - first_child);
switch (G__21821) {
case (0):
...
var vec__21892 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21892,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21892,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21892,(2),null);
...
var temp__5829__auto___22076 = reagent.impl.util.react_key_from_vec(v);
...
var temp__5829__auto___22078 = reagent.impl.util.react_key_from_vec(v);
...
var temp__5829__auto___22080 = reagent.impl.util.react_key_from_vec(v);
...
var temp__5829__auto___22082 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5829__auto___22082 == null)){
} else {
var key_22083 = temp__5829__auto___22082;
(jsprops.key = key_22083);
}
...
var temp__5829__auto___22084 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___22084 == null)){
} else {
var key_22085 = temp__5829__auto___22084;
(jsprops.key = key_22085);
}
...
var temp__5829__auto___22086 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___22086 == null)){
} else {
var key_22087 = temp__5829__auto___22086;
(jsprops.key = key_22087);
}
...
break;
default:
var G__22089 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__22090 = compiler;
v = G__22089;
compiler = G__22090;
continue;
...
(reagent.impl.template.t_reagent$impl$template22058.cljs$lang$ctorPrWriter = (function (this__5455__auto__,writer__5456__auto__,opt__5457__auto__){
return cljs.core._write(writer__5456__auto__,"reagent.impl.template/t_reagent$impl$template22058");
}));
