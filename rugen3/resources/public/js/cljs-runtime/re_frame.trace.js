...
var map__22803 = temp__5825__auto__;
var map__22803__$1 = cljs.core.__destructure_map(map__22803);
var required = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22803__$1,new cljs.core.Keyword(null,"required","required",1807647006));
var optional = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22803__$1,new cljs.core.Keyword(null,"optional","optional",2053951509));
var doc = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22803__$1,new cljs.core.Keyword(null,"doc","doc",1913296891));
var tags = (function (){var or__5162__auto__ = new cljs.core.Keyword(null,"tags","tags",1771418977).cljs$core$IFn$_invoke$arity$1(trace);
...
re_frame.trace.start_trace = (function re_frame$trace$start_trace(p__22819){
var map__22820 = p__22819;
var map__22820__$1 = cljs.core.__destructure_map(map__22820);
var operation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22820__$1,new cljs.core.Keyword(null,"operation","operation",-1267664310));
var op_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22820__$1,new cljs.core.Keyword(null,"op-type","op-type",-1636141668));
var tags = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22820__$1,new cljs.core.Keyword(null,"tags","tags",1771418977));
var child_of = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22820__$1,new cljs.core.Keyword(null,"child-of","child-of",-903376662));
...
var events = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__22821_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"event","event",301435442),new cljs.core.Keyword(null,"op-type","op-type",-1636141668).cljs$core$IFn$_invoke$arity$1(p1__22821_SHARP_));
}),batch);
...
var batch_22899 = cljs.core.deref(re_frame.trace.traces);
var seq__22826_22900 = cljs.core.seq(cljs.core.deref(re_frame.trace.trace_cbs));
var chunk__22827_22901 = null;
var count__22828_22902 = (0);
var i__22829_22903 = (0);
while(true){
if((i__22829_22903 < count__22828_22902)){
var vec__22838_22904 = chunk__22827_22901.cljs$core$IIndexed$_nth$arity$2(null,i__22829_22903);
var k_22905 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22838_22904,(0),null);
var cb_22906 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22838_22904,(1),null);
try{(cb_22906.cljs$core$IFn$_invoke$arity$1 ? cb_22906.cljs$core$IFn$_invoke$arity$1(batch_22899) : cb_22906.call(null,batch_22899));
}catch (e22842){var e_22907 = e22842;
re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error thrown from trace cb",k_22905,"while storing",batch_22899,e_22907], 0));
}

var G__22908 = seq__22826_22900;
var G__22909 = chunk__22827_22901;
var G__22910 = count__22828_22902;
var G__22911 = (i__22829_22903 + (1));
seq__22826_22900 = G__22908;
chunk__22827_22901 = G__22909;
count__22828_22902 = G__22910;
i__22829_22903 = G__22911;
continue;
} else {
var temp__5825__auto___22912 = cljs.core.seq(seq__22826_22900);
if(temp__5825__auto___22912){
var seq__22826_22913__$1 = temp__5825__auto___22912;
if(cljs.core.chunked_seq_QMARK_(seq__22826_22913__$1)){
var c__5694__auto___22914 = cljs.core.chunk_first(seq__22826_22913__$1);
var G__22915 = cljs.core.chunk_rest(seq__22826_22913__$1);
var G__22916 = c__5694__auto___22914;
var G__22917 = cljs.core.count(c__5694__auto___22914);
var G__22918 = (0);
seq__22826_22900 = G__22915;
chunk__22827_22901 = G__22916;
count__22828_22902 = G__22917;
i__22829_22903 = G__22918;
continue;
} else {
var vec__22844_22919 = cljs.core.first(seq__22826_22913__$1);
var k_22920 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22844_22919,(0),null);
var cb_22921 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22844_22919,(1),null);
try{(cb_22921.cljs$core$IFn$_invoke$arity$1 ? cb_22921.cljs$core$IFn$_invoke$arity$1(batch_22899) : cb_22921.call(null,batch_22899));
}catch (e22847){var e_22922 = e22847;
re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error thrown from trace cb",k_22920,"while storing",batch_22899,e_22922], 0));
}

var G__22923 = cljs.core.next(seq__22826_22913__$1);
var G__22924 = null;
var G__22925 = (0);
var G__22926 = (0);
seq__22826_22900 = G__22923;
chunk__22827_22901 = G__22924;
count__22828_22902 = G__22925;
i__22829_22903 = G__22926;
continue;
}
} else {
}
...
var epochs_22927 = re_frame.trace.assemble_epochs(batch_22899);
var seq__22851_22928 = cljs.core.seq(cljs.core.deref(re_frame.trace.epoch_cbs));
var chunk__22852_22929 = null;
var count__22853_22930 = (0);
var i__22854_22931 = (0);
while(true){
if((i__22854_22931 < count__22853_22930)){
var vec__22870_22932 = chunk__22852_22929.cljs$core$IIndexed$_nth$arity$2(null,i__22854_22931);
var k_22933 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22870_22932,(0),null);
var cb_22934 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22870_22932,(1),null);
try{(cb_22934.cljs$core$IFn$_invoke$arity$1 ? cb_22934.cljs$core$IFn$_invoke$arity$1(epochs_22927) : cb_22934.call(null,epochs_22927));
}catch (e22875){var e_22935 = e22875;
re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error thrown from epoch cb",k_22933,"while delivering",cljs.core.count(epochs_22927),"epoch(s)",e_22935], 0));
}

var G__22936 = seq__22851_22928;
var G__22937 = chunk__22852_22929;
var G__22938 = count__22853_22930;
var G__22939 = (i__22854_22931 + (1));
seq__22851_22928 = G__22936;
chunk__22852_22929 = G__22937;
count__22853_22930 = G__22938;
i__22854_22931 = G__22939;
continue;
} else {
var temp__5825__auto___22940 = cljs.core.seq(seq__22851_22928);
if(temp__5825__auto___22940){
var seq__22851_22941__$1 = temp__5825__auto___22940;
if(cljs.core.chunked_seq_QMARK_(seq__22851_22941__$1)){
var c__5694__auto___22942 = cljs.core.chunk_first(seq__22851_22941__$1);
var G__22943 = cljs.core.chunk_rest(seq__22851_22941__$1);
var G__22944 = c__5694__auto___22942;
var G__22945 = cljs.core.count(c__5694__auto___22942);
var G__22946 = (0);
seq__22851_22928 = G__22943;
chunk__22852_22929 = G__22944;
count__22853_22930 = G__22945;
i__22854_22931 = G__22946;
continue;
} else {
var vec__22879_22947 = cljs.core.first(seq__22851_22941__$1);
var k_22948 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22879_22947,(0),null);
var cb_22949 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22879_22947,(1),null);
try{(cb_22949.cljs$core$IFn$_invoke$arity$1 ? cb_22949.cljs$core$IFn$_invoke$arity$1(epochs_22927) : cb_22949.call(null,epochs_22927));
}catch (e22883){var e_22950 = e22883;
re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error thrown from epoch cb",k_22948,"while delivering",cljs.core.count(epochs_22927),"epoch(s)",e_22950], 0));
}

var G__22951 = cljs.core.next(seq__22851_22941__$1);
var G__22952 = null;
var G__22953 = (0);
var G__22954 = (0);
seq__22851_22928 = G__22951;
chunk__22852_22929 = G__22952;
count__22853_22930 = G__22953;
i__22854_22931 = G__22954;
continue;
}
} else {
}
