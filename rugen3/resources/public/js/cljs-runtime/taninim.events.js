...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("auth","login","auth/login",49867479),(function (p__12421,p__12422){
...
var ext_auth_response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12424,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("auth","success","auth/success",1884197866),(function (db,p__12427){
var vec__12428 = p__12427;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12428,(0),null);
var map__12431 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12428,(1),null);
var map__12431__$1 = cljs.core.__destructure_map(map__12431);
var user_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12431__$1,new cljs.core.Keyword(null,"user-id","user-id",-206822291));
var token = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12431__$1,new cljs.core.Keyword(null,"token","token",-1211463215));
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("auth","failure","auth/failure",713201887),(function (db,p__12432){
var vec__12433 = p__12432;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12433,(0),null);
var _error = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12433,(1),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("library","fetch","library/fetch",2039085303),(function (p__12436,_){
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("library","loaded","library/loaded",-1415836728),(function (db,p__12438){
var vec__12439 = p__12438;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12439,(0),null);
var albums = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12439,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("library","fetch-failed","library/fetch-failed",-2130490724),(function (db,p__12442){
var vec__12443 = p__12442;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12443,(0),null);
var _error = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12443,(1),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("lease","acquire","lease/acquire",1466340397),(function (p__12446,p__12447){
var map__12448 = p__12446;
...
var album_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12449,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("lease","acquired","lease/acquired",-331363372),(function (db,p__12452){
var vec__12453 = p__12452;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12453,(0),null);
var album_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12453,(1),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("lease","release","lease/release",-1431689167),(function (p__12456,p__12457){
...
var album_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12459,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("lease","released","lease/released",5495925),(function (db,p__12462){
var vec__12463 = p__12462;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12463,(0),null);
var album_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12463,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("lease","acquire-failed","lease/acquire-failed",1991955214),(function (db,p__12466){
var vec__12467 = p__12466;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12467,(0),null);
var album_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12467,(1),null);
var _error = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12467,(2),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("lease","release-failed","lease/release-failed",1244536122),(function (db,p__12470){
var vec__12471 = p__12470;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12471,(0),null);
var _album_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12471,(1),null);
var _error = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12471,(2),null);
return db;
}));
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("player","play","player/play",-1572447489),(function (p__12474,p__12475){
var map__12476 = p__12474;
var map__12476__$1 = cljs.core.__destructure_map(map__12476);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12476__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__12477 = p__12475;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12477,(0),null);
var track = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12477,(1),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("player","pause","player/pause",-1050709257),(function (p__12480,_){
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("player","stop","player/stop",1296737267),(function (p__12482,_){
var map__12483 = p__12482;
var map__12483__$1 = cljs.core.__destructure_map(map__12483);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12483__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("player","set-playlist","player/set-playlist",2046529511),(function (db,p__12484){
var vec__12485 = p__12484;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12485,(0),null);
var tracks = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12485,(1),null);
