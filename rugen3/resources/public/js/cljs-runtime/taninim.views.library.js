...
})], null),"Log out"], null)], null),(cljs.core.truth_(loading_QMARK_)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.loading","div.loading",-155515768),"Loading library..."], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.album-grid","div.album-grid",1190495401),(function (){var iter__5649__auto__ = (function taninim$views$library$library_view_$_iter__24151(s__24152){
return (new cljs.core.LazySeq(null,(function (){
var s__24152__$1 = s__24152;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__24152__$1);
if(temp__5825__auto__){
var s__24152__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__24152__$2)){
var c__5647__auto__ = cljs.core.chunk_first(s__24152__$2);
var size__5648__auto__ = cljs.core.count(c__5647__auto__);
var b__24154 = cljs.core.chunk_buffer(size__5648__auto__);
if((function (){var i__24153 = (0);
while(true){
if((i__24153 < size__5648__auto__)){
var album = cljs.core._nth(c__5647__auto__,i__24153);
cljs.core.chunk_append(b__24154,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [taninim.views.library.album_card,album,active_leases], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword(null,"uuid","uuid",-2145095719).cljs$core$IFn$_invoke$arity$1(album)], null)));

var G__24155 = (i__24153 + (1));
i__24153 = G__24155;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__24154),taninim$views$library$library_view_$_iter__24151(cljs.core.chunk_rest(s__24152__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__24154),null);
}
} else {
var album = cljs.core.first(s__24152__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [taninim.views.library.album_card,album,active_leases], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword(null,"uuid","uuid",-2145095719).cljs$core$IFn$_invoke$arity$1(album)], null)),taninim$views$library$library_view_$_iter__24151(cljs.core.rest(s__24152__$2)));
}
} else {
return null;
}
...
return iter__5649__auto__(albums);
})()], null))], null);
});
});
