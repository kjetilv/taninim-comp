...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(m),":",(((ss < (10)))?"0":null),cljs.core.str.cljs$core$IFn$_invoke$arity$1(ss)].join('');
});
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.track-list","div.track-list",-567258581),(function (){var iter__5480__auto__ = (function taninim$views$album$track_list_$_iter__12582(s__12583){
return (new cljs.core.LazySeq(null,(function (){
var s__12583__$1 = s__12583;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__12583__$1);
if(temp__5804__auto__){
var xs__6360__auto__ = temp__5804__auto__;
var section = cljs.core.first(xs__6360__auto__);
var iterys__5476__auto__ = ((function (s__12583__$1,section,xs__6360__auto__,temp__5804__auto__){
return (function taninim$views$album$track_list_$_iter__12582_$_iter__12584(s__12585){
return (new cljs.core.LazySeq(null,((function (s__12583__$1,section,xs__6360__auto__,temp__5804__auto__){
return (function (){
...
var c__5478__auto__ = cljs.core.chunk_first(s__12585__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__12587 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__12586 = (0);
while(true){
if((i__12586 < size__5479__auto__)){
var track = cljs.core._nth(c__5478__auto__,i__12586);
cljs.core.chunk_append(b__12587,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [taninim.views.album.track_item,track], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword(null,"uuid","uuid",-2145095719).cljs$core$IFn$_invoke$arity$1(track)], null)));

var G__12588 = (i__12586 + (1));
i__12586 = G__12588;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__12587),taninim$views$album$track_list_$_iter__12582_$_iter__12584(cljs.core.chunk_rest(s__12585__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__12587),null);
}
} else {
var track = cljs.core.first(s__12585__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [taninim.views.album.track_item,track], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword(null,"uuid","uuid",-2145095719).cljs$core$IFn$_invoke$arity$1(track)], null)),taninim$views$album$track_list_$_iter__12582_$_iter__12584(cljs.core.rest(s__12585__$2)));
}
} else {
return null;
}
...
});})(s__12583__$1,section,xs__6360__auto__,temp__5804__auto__))
,null,null));
});})(s__12583__$1,section,xs__6360__auto__,temp__5804__auto__))
;
...
if(fs__5477__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__5477__auto__,taninim$views$album$track_list_$_iter__12582(cljs.core.rest(s__12583__$1)));
} else {
var G__12589 = cljs.core.rest(s__12583__$1);
s__12583__$1 = G__12589;
continue;
}
} else {
return null;
