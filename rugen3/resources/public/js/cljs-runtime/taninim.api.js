...
taninim.api.yellin_base = "https://localhost:8081";
taninim.api.kudu_base = "https://localhost:8082";
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("api","authenticate","api/authenticate",744384885),(function (p__12418,p__12419){
var map__12420 = p__12418;
var map__12420__$1 = cljs.core.__destructure_map(map__12420);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12420__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__12421 = p__12419;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12421,(0),null);
var ext_auth_response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12421,(1),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("api","fetch-library","api/fetch-library",1631602813),(function (p__12424,_){
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("api","library-fetched","api/library-fetched",-512174506),(function (_,p__12426){
var vec__12427 = p__12426;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12427,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12427,(1),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("api","acquire-lease","api/acquire-lease",988528083),(function (p__12430,p__12431){
...
var album_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12433,(1),null);
var map__12436 = new cljs.core.Keyword(null,"auth","auth",1389754926).cljs$core$IFn$_invoke$arity$1(db);
var map__12436__$1 = cljs.core.__destructure_map(map__12436);
var fb_user_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12436__$1,new cljs.core.Keyword(null,"fb-user-id","fb-user-id",-1229679807));
var token = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12436__$1,new cljs.core.Keyword(null,"token","token",-1211463215));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("api","release-lease","api/release-lease",-110663430),(function (p__12437,p__12438){
...
var album_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12440,(1),null);
var map__12443 = new cljs.core.Keyword(null,"auth","auth",1389754926).cljs$core$IFn$_invoke$arity$1(db);
var map__12443__$1 = cljs.core.__destructure_map(map__12443);
var fb_user_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12443__$1,new cljs.core.Keyword(null,"fb-user-id","fb-user-id",-1229679807));
var token = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12443__$1,new cljs.core.Keyword(null,"token","token",-1211463215));
