...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__12517_SHARP_){
return cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$variadic(JSON.parse(p1__12517_SHARP_),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"keywordize-keys","keywordize-keys",1310784252),true], 0));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("api","authenticate","api/authenticate",744384885),(function (p__12518,p__12519){
var map__12520 = p__12518;
var map__12520__$1 = cljs.core.__destructure_map(map__12520);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12520__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__12521 = p__12519;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12521,(0),null);
var ext_auth_response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12521,(1),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("api","fetch-library","api/fetch-library",1631602813),(function (p__12524,_){
var map__12525 = p__12524;
var map__12525__$1 = cljs.core.__destructure_map(map__12525);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12525__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("api","library-fetched","api/library-fetched",-512174506),(function (_,p__12526){
var vec__12527 = p__12526;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12527,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12527,(1),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("api","acquire-lease","api/acquire-lease",988528083),(function (p__12530,p__12531){
var map__12532 = p__12530;
var map__12532__$1 = cljs.core.__destructure_map(map__12532);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12532__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__12533 = p__12531;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12533,(0),null);
var album_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12533,(1),null);
var map__12536 = new cljs.core.Keyword(null,"auth","auth",1389754926).cljs$core$IFn$_invoke$arity$1(db);
var map__12536__$1 = cljs.core.__destructure_map(map__12536);
var fb_user_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12536__$1,new cljs.core.Keyword(null,"fb-user-id","fb-user-id",-1229679807));
var token = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12536__$1,new cljs.core.Keyword(null,"token","token",-1211463215));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("api","release-lease","api/release-lease",-110663430),(function (p__12537,p__12538){
var map__12539 = p__12537;
var map__12539__$1 = cljs.core.__destructure_map(map__12539);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12539__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__12540 = p__12538;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12540,(0),null);
var album_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12540,(1),null);
var map__12543 = new cljs.core.Keyword(null,"auth","auth",1389754926).cljs$core$IFn$_invoke$arity$1(db);
var map__12543__$1 = cljs.core.__destructure_map(map__12543);
var fb_user_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12543__$1,new cljs.core.Keyword(null,"fb-user-id","fb-user-id",-1229679807));
var token = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12543__$1,new cljs.core.Keyword(null,"token","token",-1211463215));
