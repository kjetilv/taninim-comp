...
var temp__5825__auto___22894 = re_frame.registrar.get_handler.cljs$core$IFn$_invoke$arity$2(kind,id);
if(cljs.core.truth_(temp__5825__auto___22894)){
var handler_22895 = temp__5825__auto___22894;
try{var chain_or_fn_22896 = ((((cljs.core.seq_QMARK_(handler_22895)) && ((!(cljs.core.vector_QMARK_(handler_22895))))))?cljs.core.vec(handler_22895):handler_22895);
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(re_frame.registrar.kind__GT_id__GT_handler,cljs.core.assoc_in,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [kind,id], null),cljs.core.with_meta(chain_or_fn_22896,src_meta));
}catch (e22886){var __22897 = e22886;
}} else {
}
